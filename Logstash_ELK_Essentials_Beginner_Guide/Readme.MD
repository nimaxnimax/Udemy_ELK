...
Elastic Dashboards, a part of the Elastic Stack, allow you to visualize data stored in Elasticsearch. They are commonly used to monitor system logs, security events, and various other data sources.

** Filebeat System Syslog Dashboard
Filebeat is a lightweight shipper for forwarding and centralizing log data. The system syslog module in Filebeat is designed to collect and parse logs generated by the syslog service.

**Key Features:
- **Syslog Collection: Collects logs from the syslog service on Unix-like systems.
- **Pre-Built Dashboards: Includes pre-built Kibana dashboards for visualizing system logs, such as user logins, sudo command usage, and SSH login attempts.
- **Normalization: Normalizes syslog data to a structured format that is easier to analyze.

** Sudo Commands
The sudo command allows permitted users to execute a command as the superuser or another user. Logs of sudo command usage are critical for auditing and monitoring administrative activities.

**Key Metrics:
- **User Identification: Who executed the sudo command.
- **Command Executed: What command was executed using sudo.
- **Timestamp: When the sudo command was executed.
- **Host Information: On which system the command was executed.

** SSH Login Attempts
Monitoring SSH login attempts is crucial for security. These logs can help identify potential unauthorized access or brute-force attacks.

**Key Metrics:
- **Successful Logins: Number and details of successful SSH logins.
- **Failed Logins: Number and details of failed SSH login attempts.
- **Source IP Address: IP address from which the login attempt was made.
- **User Account: User account that was attempted for login.
- **Timestamp: When the login attempt occurred.

** New Users and Groups
Tracking the creation of new users and groups helps in ensuring that only authorized accounts are added to the system.

**Key Metrics:
- **User Creation: Details about new user accounts created.
- **Group Creation: Details about new groups created.
- **Creator Information: Who created the user or group.
- **Timestamp: When the user or group was created.
- **Host Information: On which system the user or group was created.

By setting up these dashboards, you can effectively monitor and analyze important system events, ensuring better security and operational visibility.

In Kibana, you can easily change the time range for displaying data on your dashboards to last 15 minutes, 30 minutes, 1 hour, 24 hours, or any other custom time range. Here’s how you can do it and an explanation of the differences:

** Changing the Time Range in Kibana Dashboards

1. **Open Kibana: Navigate to your Kibana instance in your web browser.
2. **Access the Dashboard: Go to the Dashboard section where you have your Filebeat system syslog dashboard.
3. **Time Picker: Locate the time picker at the top right corner of the Kibana interface. It typically looks like a calendar icon or has a dropdown menu showing the current time range.
4. **Select the Time Range:
   - Click on the time picker.
   - Choose a predefined time range such as “Last 15 minutes”, “Last 30 minutes”, “Last 1 hour”, or “Last 24 hours”.
   - For custom ranges, select “Quick” or “Relative” to specify the exact time range you want.

** Understanding the Differences

1. **Last 15 Minutes:
   - **Usage: Useful for real-time monitoring and immediate troubleshooting.
   - **Data Volume: Typically shows a smaller subset of data.
   - **Performance: Faster load times due to limited data range.
   - **Insight: Ideal for identifying recent or ongoing issues.

2. **Last 30 Minutes:
   - **Usage: Suitable for slightly broader real-time analysis.
   - **Data Volume: More data than 15 minutes but still focused on recent activity.
   - **Performance: Slightly slower than 15 minutes but still relatively quick.
   - **Insight: Good for seeing trends that develop over a short period.

3. **Last 1 Hour:
   - **Usage: Balances between real-time monitoring and short-term trend analysis.
   - **Data Volume: More comprehensive view of recent activities.
   - **Performance: Moderate load times due to increased data volume.
   - **Insight: Helps in identifying patterns or issues that span over the last hour.

4. **Last 24 Hours:
   - **Usage: Ideal for daily analysis and understanding broader trends.
   - **Data Volume: Shows a full day’s worth of data.
   - **Performance: Slower load times due to large data volume.
   - **Insight: Useful for daily reports, identifying periodic issues, and longer-term trends.

** Practical Use Cases

- **Security Monitoring:
  - **Last 15-30 Minutes: Detect and respond to immediate security incidents like unauthorized access attempts.
  - **Last 1 Hour: Analyze security events to identify patterns and potential ongoing threats.
  - **Last 24 Hours: Review all security-related activities to spot any anomalies or patterns.

- **System Performance Monitoring:
  - **Last 15-30 Minutes: Troubleshoot recent performance issues and spikes in resource usage.
  - **Last 1 Hour: Understand short-term performance trends and their causes.
  - **Last 24 Hours: Conduct a thorough analysis of daily performance, identifying recurring issues.

- **Operational Monitoring:
  - **Last 15-30 Minutes: Ensure that recent deployments or changes have not caused issues.
  - **Last 1 Hour: Monitor system stability and performance over a longer recent period.
  - **Last 24 Hours: Analyze the overall health and performance of systems on a daily basis.

By adjusting the time range in Kibana, you can tailor your monitoring and analysis to suit your specific needs, whether it’s immediate incident response or long-term trend analysis.
